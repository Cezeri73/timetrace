...
if (Test-Path $venvPy) {
  ...
  & $venvPy -m PyInstaller --noconfirm --onefile --windowed --name TimeTrace --add-data "settings.json;." --add-data "README.md;." main.py
} else {
  python -m pip install --upgrade pip
  python -m pip install pyinstaller
  python -m PyInstaller --noconfirm --onefile --windowed --name TimeTrace --add-data "settings.json;." --add-data "README.md;." main.py
}
